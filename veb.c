...
//	       else printf("Not Found");
     ...
     /*	node*head=NULL;q
	head=insert(1,head,16);
	head=insert(2,head,16);
	head=insert(3,head,16);
	head=insert(4,head,16);
	head=insert(5,head,16);
	head=insert(6,head,16);
	head=insert(7,head,16);
	head=insert(8,head,16);
	head=insert(9,head,16);
	head=insert(10,head,16);
	head=insert(11,head,16);
	head=insert(12,head,16);
	head=insert(13,head,16);
	head=insert(14,head,16);
	head=insert(15,head,16);
	head=insert(0,head,16);
	printf("it begins now\n");
     //print(head,16);
     printf("\n");
     if(member(head,1,16)==1)
     {
     printf("Found\n");
     head=delete(1,head,16);
     }
     else
     printf("Not Found\n");
     head=delete(2,head,16);
     head=delete(3,head,16);
     head=delete(4,head,16);
     head=delete(6,head,16);
     head=delete(7,head,16);
     //head=delete(5,head,16);
     printf("Succ\n");
     printf("successor of 1  : %d\n",succ(head,1,16));
     printf("successor of 2  : %d\n",succ(head,2,16));
     printf("successor of 3  : %d\n",succ(head,3,16));
     printf("successor of 4  : %d\n",succ(head,4,16));
     printf("successor of 6  : %d\n",succ(head,6,16));
     printf("successor of 7  : %d\n",succ(head,7,16));
     printf("successor of 15  : %d\n",succ(head,15,16));
     printf("successor of 14  : %d\n",succ(head,14,16));
     ...
     printf("%d\n ",head->bit[i]);
     for(j=0;j<2;j++)
     if(head->cluster[i]==NULL)
     printf("NULL ");
     else
     printf("%d ",head->cluster[i]->bit[j]);
     printf("\n");
     }
     //print(head,16);
     //	printf("\n");
